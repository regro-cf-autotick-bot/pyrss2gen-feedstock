...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrss2gen-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11526&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrss2gen-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrss2gen` can be installed with:

```
conda install pyrss2gen
```

It is possible to list all of the versions of `pyrss2gen` available on your platform with:
